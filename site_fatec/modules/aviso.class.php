<?php 
	class Aviso{
		...
		function update(){
			try {
				$query = "UPDATE avisos SET titulo = '$this->titulo', conteudo = '$this->conteudo', data_envio = '$this->data_envio', data_alteracao = '$this->data_alteracao', ativo = '$this->ativo' WHERE id = $this->id";
				mysql_query($query);
				return true;
			} catch (Exception $e) {
				echo 'Erro: ', $e->getmessage() ,"\n";
